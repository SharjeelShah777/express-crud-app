            ...
            response.data.map((eachPost) => {
                postsHtml +=
                    `<div id='card-${eachPost.id}' class="post-card">
                        ...
                        <p> ${eachPost.text} </p>
                        <div class="bf">
                        <button onclick="editPost('${eachPost.id}','${eachPost.title}','${eachPost.text}', )"><i class="fa-regular fa-pen-to-square"></i></button>
                        <button  onclick="delPost('${eachPost.id}')"><i class="fa-sharp fa-solid fa-trash"></i></button>
                        </div>
                    </div> 
                    <br />`
            })
